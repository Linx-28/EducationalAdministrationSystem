...
<%
    ...
    List schedules = scheduleService.findByStudentId(user.getUserId());

    Student student = studentService.findById(user.getUserId());
    ClassInfo classInfo = student != null && student.getClassId() != null ? classInfoService.findById(student.getClassId()) : null;
    ...
    String[][] courseTeacher = new String[5][5];
    for (int i = 0; i < schedules.size(); i++) {
        ...
        if (slot != null && slot.indexOf("-") >= 0) {
            ...
            if (day >= 0 && day < 5 && period >= 0 && period < 5) {
                ...
                courseTeacher[day][period] = t != null ? t.getName() : "";
            }
        }
    }
%>
...
<head>
    ...
    <style>
        ...
        .schedule-table td { border: 1px solid #e8e8e8; text-align: center; vertical-align: middle; height: 90px; padding: 4px; }
        ...
        .course-cell .course-teacher { font-size: 11px; color: #8c8c8c; }
        .schedule-info { margin-bottom: 16px; padding: 12px 16px; background: linear-gradient(135deg, #f6ffed 0%, #d9f7be 100%); border-radius: 6px; font-size: 14px; color: #389e0d; border: 1px solid #b7eb8f; }
        .schedule-info span { margin: 0 8px; }
    ...
    <div class="admin-layout">
        ...
        <div class="main-content">
            ...
            <div class="schedule-info">
                <span>班级：<b><%=classInfo.getClassName()%></b></span>
                <span>专业：<b><%=classInfo.getMajor()%></b></span>
                <span>年级：<b><%=classInfo.getGrade()%></b></span>
            </div>
            <% } %>
            <div class="card">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <div class="course-cell">
                                    ...
                                    <div class="course-teacher"><%=courseTeacher[d][p]%></div>
                                </div>
                                <% } %>
                            </td>
                            <% } %>
